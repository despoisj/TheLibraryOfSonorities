...
<p>*m* 7:08 piano (top staff) arpeggios up/down end of mm. 2 & start of mm. 3 at  - C# (D#) E G# i.e. ^1 (^2) b^3 ^5.</p>
<?php yt("eh3l8I-JT4Q", 24) ?>

<?php tt("Józef Wieniawski - Ballade Op. 31") ?>
...
<p>*M* Last/first measure: D-(E)-F#-A then minor version B-(C)-D-F#.</p>
<?php yt("ZC7GleTGtkY", 184) ?>

<?php tt("Anton Arensky - Etude, Op. 74 n°2") ?>
<p>- *m* as the intro bar: C-(D)-Eb-G with G then moving as a melody</p>
<p>- *M* mm. 2: Eb-(F)-G-Bb with an added C (6th/13th), same at 2:17</p>
<p>- Augmented version (ignoring the extra notes for now) mm. 3: Eb-(F)-G-Cb. Note: for that one, the arpeggio outlines the Eb <a href="index.php?filter=element&element=harmonic_major">Harmonic Major</a> scale .</p>
