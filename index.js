...
function replaceDigitsWithCircledNumbers(text) {
    ...
    text = text.replaceAll(/VChM9/g, makeItem("VCh<small><small>Maj</small><sup>9</sup></small>", "vchMaj9", "chopin_chord"));
    text = text.replaceAll(/VChmb9/g, makeItem("VCh<small><small>min</small><sup>♭9</sup></small>", "vchMinb9", "chopin_chord"));
    ...
    text = text.replaceAll(/V11(?!.*<\/h[1-9]>)/g, makeItem("V11", "v9", "V9_chord"));
