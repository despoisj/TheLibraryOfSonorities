...
<html lang="en">
    ...
    <body>
        ...
        <?php if ($filter == "") { ?>
            ...
            <p>The goal of this site is to list a number of 'sonorities', as well as which sonorities are landmarks of a given composer. Even if you can find augmented chords in Bach's works, they aren't a staple of his style. I have chosen to focus mostly on romantic music as it's my favorite, and resources on it are very scarce. This website's goal is to help you identify the sounds you like and use them in your improvisation, rather than trying to be exhaustive in the voice leading and exceptions of each improvisational device. For the latter, check out the references.</p>
            </div>
